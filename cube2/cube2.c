...
/*void r3d_clip_work(r3d_brep* poly, r3d_plane* planes, r3d_int nplanes, r3d_int** work) {
		...
		for(int v = firstnewvertsind; v<newnverts; ++v){
			...
			do  {
				...
				if (crossing_vertex) {
					...
					work[newnfaces][nextavail++] = crossing_vertex;
...
int main() {
	...
	r3d_int nverts = 9;
	r3d_int nfaces = 9;
	r3d_int nvertsperface[R3D_MAX_FACES] = {4,4,4,4,4,3,3,3,3}; //we may need an R3D_MAX_FACES
	r3d_int f0[R3D_MAX_VERTS_PER_FACE] = {0,1,5,4};
	r3d_int f1[R3D_MAX_VERTS_PER_FACE] = {1,2,6,5};
	r3d_int f2[R3D_MAX_VERTS_PER_FACE] = {2,3,7,6};
	r3d_int f3[R3D_MAX_VERTS_PER_FACE] = {0,4,7,3};
	r3d_int f4[R3D_MAX_VERTS_PER_FACE] = {0,3,2,1};
	r3d_int f5[R3D_MAX_VERTS_PER_FACE] = {4,5,8};
	r3d_int f6[R3D_MAX_VERTS_PER_FACE] = {5,6,8};
	r3d_int f7[R3D_MAX_VERTS_PER_FACE] = {6,7,8};
	r3d_int f8[R3D_MAX_VERTS_PER_FACE] = {4,8,7};
	r3d_int f9[R3D_MAX_VERTS_PER_FACE], f10[R3D_MAX_VERTS_PER_FACE];
	r3d_int* faceinds[R3D_MAX_FACES] = {&f0,&f1,&f2,&f3,&f4,&f5,&f6,&f7,&f8,&f9, &f10}; //do we need another variable for faceinds
	...
	for(int x = 0; x < REP_TIMES; ++x) {
		...
		r3d_brep poly, poly2; //r3d_brep poly{verts, nverts, faceinds, nvertsperface, nfaces};
		...
		r3d_int* newfaceinds[R3D_MAX_VERTS] = {&f0,&f1,&f2,&f3,&f4,&f5,&f6,&f7,&f8,&f9,&f10};	
